...
public class Smtp_mail
{
     ...
     {
          int delay = 1000;
          String user = "s1811176143@ru.ac.bd";     //edu mail
          String pass = "niececeeujdufbyx";             //edu mail password
          ...
          send("MAIL FROM:<s1811176143@ru.ac.bd>\r\n");
          Thread.sleep(delay);
          System.out.println("SERVER: "+br.readLine());
          
          send("RCPT TO:<khairulrucse26@gmail.com>\r\n");
          Thread.sleep(delay);
          System.out.println("SERVER: "+br.readLine());
